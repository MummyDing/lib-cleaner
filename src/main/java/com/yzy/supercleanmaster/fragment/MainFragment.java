...
public class MainFragment extends BaseFragment {
    ...
    private void initViews() {
        bindView(arcStore, R.id.arc_store);
        bindView(arcProcess, R.id.arc_process);
        bindView(capacity, R.id.capacity);

        mRootView.findViewById(R.id.card1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                speedUp();
            }
        });
        mRootView.findViewById(R.id.card2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rubbishClean();
            }
        ...
        mRootView.findViewById(R.id.card3).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mRootView.findViewById(R.id.card4).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
