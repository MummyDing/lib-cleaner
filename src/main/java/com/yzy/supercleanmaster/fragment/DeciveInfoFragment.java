...
public class DeciveInfoFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        mRootView = inflater.inflate(R.layout.fragment_device_info, container, false);
    ...
    private void findViewsBId() {
        bindView(mWebView, R.id.webView);
        bindView(mProgressBar, R.id.progress_bar);
    }
